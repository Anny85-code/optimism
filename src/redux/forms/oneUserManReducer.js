...
const FAILED_GET_ONE_USER =
  'src/redux/userreducer/failed_get_one_user'.toUpperCase();
const GET_ONE_USER_REQUEST =
  'src/redux/userreducer/get_one_user_request'.toUpperCase();
